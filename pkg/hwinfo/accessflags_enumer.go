// Code generated by "enumer -type=AccessFlags -json -trimprefix AccessFlags"; DO NOT EDIT.
...
const _AccessFlagsName = "UnknownReadOnlyWriteOnlyReadWrite"

var _AccessFlagsIndex = [...]uint8{0, 7, 15, 24, 33}

const _AccessFlagsLowerName = "unknownreadonlywriteonlyreadwrite"

func (i AccessFlags) String() string {
	if i < 0 || i >= AccessFlags(len(_AccessFlagsIndex)-1) {
...
var _AccessFlagsNameToValueMap = map[string]AccessFlags{
	...
	_AccessFlagsName[7:15]:       AccessFlagsReadOnly,
	_AccessFlagsLowerName[7:15]:  AccessFlagsReadOnly,
	_AccessFlagsName[15:24]:      AccessFlagsWriteOnly,
	_AccessFlagsLowerName[15:24]: AccessFlagsWriteOnly,
	_AccessFlagsName[24:33]:      AccessFlagsReadWrite,
	_AccessFlagsLowerName[24:33]: AccessFlagsReadWrite,
}

var _AccessFlagsNames = []string{
	_AccessFlagsName[0:7],
	_AccessFlagsName[7:15],
	_AccessFlagsName[15:24],
	_AccessFlagsName[24:33],
}
